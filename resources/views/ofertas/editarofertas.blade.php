...
<div class="container">
	<div class="row">
		<div class="col-xs-12 col-sm-10 col-sm-offset-1">
			<h1 class="text-center color-azul"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; Edición de Oferta&nbsp; <i class="fa fa-pencil-square-o" aria-hidden="true"></i></h1>
            <ul class="nav nav-pills">
                <li class="active"><a data-toggle="pill" href="#home"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Editar Ofertas </a></li>
            </ul>
          
          <div class="tab-content">
           
            <div id="home" class="tab-pane fade in active">
                {!! Form::open(['route' => 'Ofertas/EditarOfertas', 'class' => 'form','method' => 'POST','id'=> 'EditarOfertaForm']) !!}
              <div class="panel panel-default">

                <div class="panel-heading fondo-naranja-oscuro color-blanco">
                    <h2 class="panel-title text-center" style="font-weight:bold;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; Oferta N° {{$ofertas[0]->id}}</h2></h2>
                </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                              ...
                              <input type="text" class="form-control" id="titulo_oferta" name="titulo_oferta"  required maxlength="100" value="{{$ofertas[0]->titulo_oferta}}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4">
                            ...
                            <select class="form-control text-center" name="nEstado_Oferta" id="nEstado_Oferta">
                        ...
                        <div class="form-group">
                          <fieldset>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="number" step="0.1" class="form-control"  id="precio_oferta" name="precio_oferta"  required  value="{{$ofertas[0]->precio_oferta}}">
                                <span  id ="ErrorMensaje-precio_oferta" class="help-block"></span>
                            </div>
                            <div class="col-sm-4">
                                <label class="color-azul">Precio Real</label>
                                <input type="number" step="0.1" class="form-control"  id="precio_real" name="precio_real"  required  value="{{$ofertas[0]->precio_real}}">
                        ...
                        <div class="form-group">
                          <fieldset>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="date" class="form-control"  id="fecha_termino" name="fecha_termino" value="{{$ofertas[0]->fecha_termino}}" required>
                        ...
                        <div class="form-group">
                          <fieldset>
                            ...
                            <img src="{{$ofertas[0]->ruta_imagen_oferta}}" class="img img-responsive imagen-oferta" alt="Imagen de Producto">
                                ...
                                <div class="table-responsive">
                                  <table id="tabla" class="table table-hover">
                                    ...
                                    @foreach ($ofertasdetalles as $ofertasdetalle)
                                    	<tr class='row-fila-detalle'><td><textarea name='descripcion_detalle[]' id='descripcion_detalle' class='form-control descripcion_detalle' rows='3'  required 
                                    	>{{$ofertasdetalle->descripcion_detalle}}</textarea></td><td style='vertical-align: middle;' class='eliminar-fila-detalle text-center'><button type='button' class='btnEliminarFila btn btn-danger'>Eliminar</button></td></tr>
                                    @endforeach
                                    </tbody>
                                  </table>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" id = "btnEditarOferta" class="btnEditarOferta btn btn-principal" value="Editar Oferta">
                        </div>
                    </div>
              </div>
              {!! Form::close() !!}
