            ...
            <div id="home" class="tab-pane fade in active">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <h2 style="display:none;"><div class="title-part">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="comentario_servicio" id="comentario_servicio" class="form-control" rows="3" required="required" readonly>{{$encuestas[0]->descripcion_comentario}}</textarea>
                                ...
                                <fieldset class="clsEncuesta">
    								...
    								@foreach($cuestionarios as $cuestionario)
                                        @if($cuestionario->id == $pregunta->id )
                                            <label class="input-group input-group-radio row" readonly>
            									
                                            	@if($respuestas[$pregunta->id - 1]->codigo_respuesta == $cuestionario->CodigoOpcion)
                                            	...
                                            	@else
                                            		...
                                            		<input type="radio" name="{{$pregunta->id}}" value="{{$cuestionario->CodigoOpcion}}" style="margin-left: 10px;
            													margin-right: 10px;" disabled>
                                            	@endif
